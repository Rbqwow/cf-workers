// Thanks to https://github.com/ruddra/cloudflare-google-fonts-cache
 ...
 * */
    ...
    const subPath = ""; // your domain subpath ie, https://domain.com/fonts
    ...
    async function handleRequest(event) {
      ...
      if (url.pathname === "/") {
        // Return a 302 redirect to another URL
